...
def evaluate(refs, preds, task="classification"):
    if task == "classification":
        ...
        print('Metrics: aca=%2.5f -  kappa=%2.3f -  macro f1=%2.3f -  auc=%2.3f -AMD_auc=%2.3f'
              % (metrics["aca"], metrics["kappa"],metrics["f1_avg"],metrics["auc_avg"],metrics["AMD_auc"]))
...
def classification_metrics(refs, preds):
    ...
    AMD_auc = roc_auc_score(refs, preds,multi_class='ovr')
...
def average_folds_results(list_folds_results, task):
    ...
    if task == "classification":
        ...
        print('Metrics: aca=%2.3f(%2.3f) -  kappa=%2.3f(%2.3f) - macro f1=%2.3f(%2.3f) -'
            ...
            out["kappa_avg"], out["kappa_std"], out["f1_avg_avg"], out["f1_avg_std"],
             out["AMD_auc_avg"], out["AMD_auc_std"]
           ))
